...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun 23 09:44:16 2020
...
class Agente:
    ...
    # Método donde creamos la DNN para estimar tanto la función de target: 
    # Función de creación de la DNN #    
    def _build_compile_model(self):
        
        K = keras.backend
        
        # Creamos el backend de Keras #
        input_states = keras.layers.Input((25,19,3)) # Capa de entrada
        # Capas ocultas 1 y 2 #
        convolucional = Conv2D(8, kernel_size=(5, 5), strides=(2, 2),
                         activation='elu')(input_states)
        convolucional2 = Conv2D(4, kernel_size=(3, 3), strides=(1, 1),
                 activation='elu')(convolucional)
        hidden0 = Flatten()(convolucional2)
        hidden1 = keras.layers.Dense(512,activation = "elu")(hidden0)
        hidden2 = keras.layers.Dense(512,activation = "elu")(hidden1)
        # Función de valor V(s) #
        state_values = keras.layers.Dense(1)(hidden2)
        # Funcion de ventaja A(s)
        raw_advantages =keras.layers.Dense(8)(hidden2)
        advantages = raw_advantages - K.max(raw_advantages, axis = 1, keepdims = True)
        # De la fórmula A = Q - V #
        Q_values = state_values + advantages
        # La función que estima Q será #
    ...
    def make_a_training_step(self,batch_size):
        ...
        # Predecimos los valores de Q(s, cada acción) con la FUNCION DEL MODELO
...
for episode in tqdm(range(0,num_of_episodes),desc='Progreso: '):
    ...
    # Soft Update del la red del target #
...
# Guardamos la ultima #
Barco.model.save("Dueling_Ypacarai_Model_LAST.h5")
Barco.model.set_weights(best_weights)
# Guardamos la red con los pesos #
Barco.model.save("Dueling_Ypacarai_Model_BEST.h5")
    
print("\n Terminado! \n")

np.savetxt("reward_Dueling_2D.csv", r_buffer, delimiter=",")
